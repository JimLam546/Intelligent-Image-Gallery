...
/**
 * 自定义权限加载接口实现类
 * 说明：当进行注解或方法进行权限校验时，会调用此接口的 getPermissionList 方法进行权限获取
 */
...
public class StpInterfaceImpl implements StpInterface {
     ...
     * 返回一个账号所拥有的权限码集合
     * 说明：
     * 1.将请求参数封装为 SpaceUserAuthContext 对象
     * 2.根据 SpaceUserAuthContext 参数判断是操作公共图库还是私人图库还是团队图库
     * 3.判断完是哪种图库以后放回相应的权限集合。
     * 4.如果是团队图库，则需要判断当前登录用户是否是团队成员，如果是则返回权限集合，否则返回空集合
     */
    @Override
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if (ObjectUtil.isNotNull(id)) {
            ...
            String moduleName = CharSequenceUtil.subBefore(partUri, "/", false);
            switch (moduleName) {
                case "picture":
